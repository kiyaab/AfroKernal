...
export const MIGRATION_GUIDES: MigrationGuide[] = [
  {
    ...
    subtitle: "Complete safe migration guide: backup, software replacement, Live USB testing, and installation.",
    icon: "🪟",
    ...
    steps: [
      ...
      },
      {
        ...
        warning: "Without disabling Fast Startup, you may get 'drive is locked / read-only' errors in Linux."
      },
      {
  ...
  },
  {
    ...
    subtitle: "Transition from Apple ecosystem to Linux: keyboard shortcuts, terminal familiarity, and audio workflows.",
    icon: "🍎",
    ...
    steps: [
      ...
      },
      {
        ...
        commands: ["# For Apple Silicon M1/M2 Macs, run from macOS Terminal:\ncurl https://fedora-asahi-remix.org/install | sh"]
      }
    ]
  },
  {
    ...
    subtitle: "Share your computer with both Windows and Linux without risking data loss or broken bootloaders.",
    icon: "⚡",
    ...
    steps: [
      {
        ...
        warning: "Never use third-party partition tools while Windows is actively running without backups."
      },
      {
      ...
      },
      {
        ...
        commands: ["# Run in Linux to synchronize with Windows RTC:\ntimedatectl set-local-rtc 1 --adjust-system-clock"]
      }
    ]
  }
];
