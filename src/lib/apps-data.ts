    ...
    alternatives: [
      {
        ...
        description:
          "The GNU Image Manipulation Program. High-powered raster graphics editor with layered editing, scripting, and Photoshop-like keyboard plugin packs (PhotoGIMP).",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Professional digital painting and 2D illustration application with advanced brush engines, CMYK support, and stabilizer tools.",
      ...
      },
      {
        ...
        description:
          "In-browser Photoshop replica that opens and saves native .PSD files with layers, smart objects, and filters.",
    ...
    alternatives: [
      {
        ...
        license: "Free & Open Source",
        description:
          "The gold standard open-source office suite. Full compatibility with .docx, .xlsx, and .pptx formats without telemetry.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Modern, tabbed office suite with 100% direct native OOXML Microsoft format fidelity and collaborative editing.",
    ...
    alternatives: [
      {
        ...
        license: "Free / Proprietary",
        description:
          "Hollywood-grade video editing, color grading, visual effects (Fusion), and audio post-production (Fairlight) running natively on Linux.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Powerful multi-track open-source video editor built on MLT and KDE frameworks with proxy clips, keyframes, and motion tracking.",
    ...
    alternatives: [
      {
        ...
        license: "Free & Open Source",
        description:
          "Code editing redefined. VSCodium is 100% telemetry-free binaries of Microsoft's VS Code with full extensions marketplace.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Notepadqq is a Notepad++ clone for Linux with syntax highlighting for 100+ languages, regex search, and multi-cursors.",
    ...
    alternatives: [
      {
        ...
        license: "Free / Proprietary",
        description:
          "Vesktop is a custom Discord client that gives Linux users working Wayland screen sharing with audio and Vencord plugins.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Decentralized, end-to-end encrypted messaging network and secure team collaboration client.",
    ...
    alternatives: [
      {
        ...
        license: "Free & Open Source",
        description:
          "Free file archiver supporting over 200 archive formats with strong encryption, file splitting, and duplicate finders.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Native KDE and GNOME desktop archive managers integrated right into your file manager right-click context menu.",
    ...
    alternatives: [
      {
        ...
        license: "Free & Open Source",
        description:
          "Native Linux launcher for Epic Games, GOG, and Prime Gaming with built-in Proton and Wine prefix management.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Open gaming platform for Linux that installs and manages games from GOG, Steam, Battle.net, Origin, Ubisoft, and emulators.",
    ...
    alternatives: [
      {
        ...
        license: "Free & Open Source",
        description:
          "End-to-end encrypted password manager with cross-platform sync, autofill, 2FA authenticator, and self-hosting options.",
      ...
      },
      {
        ...
        license: "Free & Open Source",
        description:
          "Community fork of KeePassX for 100% offline, local database password storage with SSH agent integration and YubiKey support.",
