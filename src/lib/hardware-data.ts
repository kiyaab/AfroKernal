export interface HardwareItem {
  category: "GPUs" | "Wi-Fi & Bluetooth" | "Laptops" | "Printers & Scanners" | "Audio & Peripherals";
  name: string;
  compatibility: "Platinum (Out-of-the-box)" | "Gold (Driver install required)" | "Silver (Minor tweaks needed)" | "Unsupported / Problematic";
  kernelDriver: string;
  notes: string;
...
export const HARDWARE_DATA: HardwareItem[] = [
  {
    ...
    notes: "Flawless Linux support. Works out of the box on all modern distributions without installing extra packages.",
  ...
  },
  {
    ...
    notes: "Requires DKMS module installation on older distros. Modern Ubuntu & Mint driver managers auto-detect and install it in 1 click.",
  ...
  },
  {
    ...
    notes: "Requires proprietary broadcom driver. Need ethernet connection or offline USB driver package during first install.",
  ...
  },
  {
    ...
    notes: "Zero proprietary driver setup. Full Vulkan 1.3, Wayland, FreeSync, and HDR support in upstream Mesa.",
  ...
  },
  {
    ...
    notes: "Requires proprietary nvidia-driver-550+. Flawless Wayland support with explicit sync enabled in recent drivers.",
  ...
  },
  {
    ...
    notes: "Official tier-1 Linux hardware partner with Lenovo. TrackPoint, power profiles, battery thresholds, and suspend work out of the box.",
  ...
  },
  {
    ...
    notes: "Certified for Ubuntu Linux. HiDPI scaling, Thunderbolt 4 docks, and sleep modes fully functional.",
  ...
  },
  {
    ...
    notes: "HPLIP (HP Linux Imaging and Printing) is pre-installed in almost all Linux distributions. Auto-discovers network printers via mDNS/Avahi.",
  ...
  },
  {
    ...
    notes: "Modern models support driverless IPP printing out of the box. Older USB printers require deb/rpm from Brother website.",
