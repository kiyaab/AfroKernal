    ...
    links: [
      {
        ...
        desc: "Official RHEL product documentation.",
      },
      {
        name: "Rocky Linux",
        url: "https://docs.rockylinux.org",
        desc: "RHEL-compatible community rebuild.",
      },
      {
        name: "AlmaLinux Wiki",
        url: "https://wiki.almalinux.org",
        desc: "Free enterprise-grade OS.",
      },
      {
        name: "Fedora Docs",
        url: "https://docs.fedoraproject.org",
        desc: "Upstream of RHEL — bleeding edge stable.",
      },
      {
        name: "Oracle Linux",
        url: "https://docs.oracle.com/en/operating-systems/oracle-linux/",
        desc: "Oracle's RHEL-compatible distro.",
      },
    ...
    links: [
      {
        ...
        desc: "Server, Desktop, Core, LXD, MAAS.",
      },
      {
      ...
      {
        name: "Linux Mint User Guide",
        url: "https://linuxmint-user-guide.readthedocs.io",
        desc: "Beginner-friendly Ubuntu derivative.",
      },
      {
        name: "Kali Linux Docs",
        url: "https://www.kali.org/docs/",
        desc: "Penetration testing distribution.",
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        desc: "The best Linux wiki on the internet — even non-Arch users use it.",
      },
      {
        name: "Gentoo Wiki",
        url: "https://wiki.gentoo.org",
        desc: "Source-based Linux distribution.",
      },
      {
        name: "Slackware Docs",
        url: "https://docs.slackware.com",
        desc: "The oldest surviving Linux distribution.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        desc: "The most widely used DNS server.",
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        desc: "Metrics and alerting toolkit.",
      },
      { name: "Grafana", url: "https://grafana.com/docs/", desc: "Dashboards for anything." },
      {
        name: "Zabbix",
        url: "https://www.zabbix.com/documentation/",
        desc: "Enterprise monitoring platform.",
      },
      {
        name: "Nagios Core",
        url: "https://assets.nagios.com/downloads/nagioscore/docs/",
        desc: "The classic monitoring tool.",
      },
    ],
  },
];
