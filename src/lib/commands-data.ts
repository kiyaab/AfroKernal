export interface CommandTranslation {
  windowsCmd: string;
  linuxCmd: string;
  category: "Files & Navigation" | "Networking" | "Process Management" | "System Info" | "Disks & Storage" | "User Management" | "Permissions & Security";
  description: string;
...
export const COMMANDS_DATA: CommandTranslation[] = [
  {
    ...
    linuxExample: "ls -la",
    notes: "In Linux, files starting with '.' are hidden. Use '-la' for long listing and hidden files."
  },
  {
    windowsCmd: "cd",
    linuxCmd: "cd",
    ...
    notes: "Linux uses forward slashes '/' instead of backslashes '\\'. '~' refers to the home directory."
  },
  {
