  ...
  head: () => ({
    meta: [
      { title: "Linux Command Reference — AfroKernel Docs" },
      {
        name: "description",
        content:
          "Free interactive documentation for every core Linux command — syntax, examples, common mistakes, and AI-powered explanations.",
      },
      { property: "og:title", content: "AfroKernel Linux Command Reference" },
      {
        property: "og:description",
        content: "Every core Linux command explained: syntax, examples, mistakes.",
      },
    ],
  }),
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Every command with syntax, examples, common mistakes — grounded in the AfroKernel
            curriculum.
          </p>
        </div>
            ...
            {cmds.map((c) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <code className="font-mono font-semibold group-hover:text-primary transition-colors">
                    {c.name}
                  </code>
                </div>
    ...
    <header className="border-b border-border/60 backdrop-blur sticky top-0 z-40 bg-background/80">
      <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/chat" className="text-sm hover:text-primary ml-4">
            AI Tutor
          </Link>
          <div className="ml-4">
            <ThemeToggle />
