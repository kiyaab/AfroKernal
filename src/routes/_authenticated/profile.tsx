...
const BADGES = [
  ...
  {
    id: "badge-rhel-specialist",
    name: "Red Hat Enterprise Specialist",
    category: "Enterprise Linux",
    icon: "🎩",
    desc: "Configured systemd units, storage volumes, and user permissions on Enterprise Linux.",
    req: "Complete RHEL track",
    date: "August 2026",
    certId: "AK-RHEL-49201",
    color: "from-red-500/20 to-amber-500/10 border-red-500/30 text-red-400",
  },
  {
    id: "badge-bash-pro",
    name: "Bash Automation Master",
    category: "Scripting",
    icon: "⚡",
    desc: "Authored robust shell scripts, text pipelines, and automated sysadmin routines.",
    req: "Complete Bash Scripting track",
    date: "August 2026",
    certId: "AK-BSH-38291",
...
function ProfilePage() {
  ...
  const skillsData = [
    ...
    { name: "Enterprise Linux (RHEL)", pct: 65, grade: "Intermediate" },
