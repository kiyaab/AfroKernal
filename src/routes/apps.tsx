        ...
        <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <p className="text-muted-foreground text-base max-w-2xl mt-1">
              Find the best free and open-source Linux replacements for proprietary Windows and
              macOS software. Compare features, upvote community favorites, and get instant terminal
              install commands.
            </p>
          </div>
          <button
              ...
              >
                ...
                <div className="grid gap-4 mt-6 md:grid-cols-2 lg:grid-cols-3">
                  {app.alternatives.map((alt) => {
                    ...
                    const currentVote = votesState[voteKey] || {
                      count: alt.votes,
                      userVoted: false,
                    };
                    const bestInstallCmd =
                      alt.installCmds.flatpak ||
                      alt.installCmds.apt ||
                      alt.installCmds.pacman ||
                      "";
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSuggestForm({ ...suggestForm, windowsApp: e.target.value })
                      }
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setSuggestForm({ ...suggestForm, category: e.target.value })
                        }
