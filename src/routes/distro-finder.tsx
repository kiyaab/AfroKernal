  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        desc: "Programming in Python, Rust, Go, C/C++, Node.js, and local development environments.",
        value: "development",
        icon: "🛠️",
      },
      {
      ...
      {
        label: "Server Administration & Self-Hosting",
        desc: "Homelabs, enterprise services, network administration, or long-term production servers.",
        value: "server",
        icon: "🖥️",
      },
    ],
