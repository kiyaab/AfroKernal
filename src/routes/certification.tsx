  ...
  head: () => ({
    meta: [
      { title: "Linux Certifications — AfroKernel" },
      {
        name: "description",
        content:
          "Earn verifiable Linux, Cybersecurity, and DevOps certifications. Share on LinkedIn with permanent verification.",
      },
...
const TRACKS: CertTrack[] = [
  {
    ...
    description:
      "Demonstrate competence across standard Unix/Linux system administration commands, text processing (grep, sed, awk), user management, and systemd services.",
    topics: [
  ...
  },
  {
    ...
    description:
      "Prove your ability to audit Linux servers, configure host firewalls (UFW/iptables), analyze Wireshark packet captures, and identify common vulnerabilities.",
    topics: [
    ...
    sampleQuestion:
      "What is the primary benefit of running 'nmap -sS' over a standard full TCP connect scan?",
  },
  {
    id: "devops",
    ...
    description:
      "Validate real-world containerization expertise: multi-stage Dockerfiles, Docker Compose architectures, Kubernetes Pods/Services, and declarative infrastructure.",
    topics: [
    ...
    sampleQuestion:
      "How do multi-stage Dockerfiles reduce final production container image attack surface and size?",
  },
];
        ...
        <div className="rounded-3xl border border-border bg-card p-8 md:p-12 shadow-sm space-y-8 mb-16">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-border">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mt-1">
                {selectedTrack.name} Exam Syllabus
              </h2>
            </div>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {selectedTrack.topics.map((topic, i) => (
                <div
                  key={i}
                  className="p-3.5 rounded-xl bg-background/60 border border-border flex items-center gap-2.5"
                >
          ...
          <div className="p-6 rounded-2xl bg-secondary/40 border border-border space-y-3">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground pt-1">
              ...
              <span>
                Practice this and 50+ real exam questions on the free practice test simulator.
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Upon completing any certification exam with a score of 70% or higher, your
                verifiable certificate is generated automatically.
              </p>
              <ul className="space-y-3 text-xs text-foreground/90 pt-2">
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                  <span>
                    <strong>Verifiable PDF Download</strong> — Instantly download your
                    high-resolution signed PDF certificate.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                  <span>
                    <strong>Add to LinkedIn Profile</strong> — Display under "Licenses &
                    Certifications" with a permanent public verification URL.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                  <span>
                    <strong>Permanent Access</strong> — Your credentials and Road Warrior tutorials
            ...
            <div className="rounded-2xl border-2 border-primary/30 bg-background/90 p-8 shadow-2xl space-y-4 text-center font-serif relative">
              ...
              <div className="text-xl font-bold text-primary font-sans">
                Linux Administrator Candidate
              </div>
              <p className="text-xs font-sans text-muted-foreground">
                has successfully passed the comprehensive exam for
              </p>
